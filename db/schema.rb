...
ActiveRecord::Schema.define(version: 20160709010811) do
  ...
  create_table "reviewers", force: :cascade do |t|
    ...
    t.index ["email"], name: "index_reviewers_on_email", using: :btree
    t.index ["reset_password_token"], name: "index_reviewers_on_reset_password_token", unique: true, using: :btree
    t.index ["uid", "provider"], name: "index_reviewers_on_uid_and_provider", unique: true, using: :btree
  end
